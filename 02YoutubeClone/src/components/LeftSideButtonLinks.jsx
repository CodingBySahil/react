...
const LeftSideButtonLinks = () => {
  return (
    <>
    <div className={'col-2 position-fixed" id="left-side-buttons-links'}
                style="top: 10% !important; background-color: white;">

                <div className={'d-flex justify-content-start align-items-center p-2" id="icon-text'}>
                    <div className={'px-4'}>
                ...
                <div className={'p-1'}>
                    <p className={'px-4 fw-bolder'}>You
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16"
                                focusable="false"
                                style="pointer-events: none; display: inherit; width: 11%; height: 11%;">
                ...
                <div className={'d-flex justify-content-start align-items-center p-2" id="icon-text'}>
                    <div className={'px-4'}>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" focusable="false"
                            style="pointer-events: none; display: inherit; width: 30px; height: 30px;">
                            <defs>
                            ...
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <g fill-rule="nonzero">
                                    ...
                                    <path fill="url(#a_yt70)" fill-opacity=".1"
